...
class Author(models.Model):
    ...
    image=models.ImageField(upload_to="author")  #pillow must be installed
    dob=models.DateField()
    slug=models.SlugField(unique=True)    #unique value (value is passing instead of id)
    ...
    def get_absolute_url(self):
        return reverse("author-detail",kwargs={"link":self.slug})
...
class Book(models.Model):
    ...
    slug=models.SlugField(unique=True)
    image=models.ImageField(upload_to="books",default="books/default_images.jpg")
